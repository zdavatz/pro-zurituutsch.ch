...
- Typography: Header uses "Roboto Condensed" at 42pt, normal weight (loaded via Google Fonts, with Arial Nova Cond/Arial Narrow as fallbacks); body text uses Arial. Header padding is 0.8em top / 0.75em bottom
