...
- RSS feed: `/PodCast/IndexPage?action=rss` — 239 episodes, 224 with MP3 enclosures, 15 without audio
...
- MP3 audio files are tracked with **Git LFS**

## Conventions

- The custom skin follows XHTML 1.1 strict compliance and CSS 2.0 (no table layouts)
- Typography: Header uses "Roboto Condensed" at 42pt, normal weight (loaded via Google Fonts, with Arial Nova Cond/Arial Narrow as fallbacks); body text uses Arial. Header padding is 0.8em top / 1.0em bottom (slightly bottom-biased centering)
